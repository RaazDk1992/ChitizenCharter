...
import 'package:noticeboard/worker/fetchelected.dart';

import '../models/staffs.dart';
import '../worker/fetchstaffs.dart';

class ElectedSlider extends StatefulWidget {
  const ElectedSlider({super.key});

  @override
  State<ElectedSlider> createState() => _ElectedSliderState();
}

class _ElectedSliderState extends State<ElectedSlider> {
  List<Elected> staff = [];
  ...
  getStaffs() async {
    staff = (await FetchElected().getElected())!;
    if (staff != null) {
      setState(() {
        isStaffLoaded = true;
      });
